...
public class LSTMNetwork {
    ...
    private static double learningRate = 0.45;
    private static int exampleLength = 128;
    private static int lstmLayer1Size = 5;
    private static int lstmLayer2Size = 50;
    private static int denseLayerSize = 1;
